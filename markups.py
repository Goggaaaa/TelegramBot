...
feeding = InlineKeyboardButton('📊 Рассчитать ИМТ', callback_data='feeding')
nutrition = InlineKeyboardButton('🍏 Питание', callback_data='nutrition')
'''oplata = InlineKeyboardButton('💲 Индивидуальный план', callback_data='oplata')'''
profile = InlineKeyboardButton('👤 Профиль', callback_data='profile')
main_menu = InlineKeyboardMarkup(row_width=1).add(trainings, feeding, nutrition, profile)
...
body_index = InlineKeyboardButton('📊 Начать рассчет ИМТ', callback_data='body_index')
